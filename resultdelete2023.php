...
<head>
	<style>
		...
		#bt{border-radius: 10px; background-color: khaki;white;font-size: 15pt;}
...
echo "failed tom connect to mysql:".mysqli_connect_error();
	...
	$result=mysqli_query($con,"SELECT * FROM sbr");
...
?>
<form name="f1" acrtion="resultdelete2023.php" method="POST">
	<table id="tab" border="0">
		...
		<bt id="bt"><a href="http://localhost/sbr/admin/welcomeadmin.php">back</a></button>
		...
		if(isset($_POST['b1']))
		{
			...
			$con=mysqli_connect("localhost","root","","sbrcollege");
				...
				$result=mysqli_query($con,"DELETE FROM sbr where Resistor_No='$rn'");
				echo"</table>";
