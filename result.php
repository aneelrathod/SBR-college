...
<button class="btn btn-warning"><a href ="http://localhost/sbr/admin/sbrviewdata.php">Click here for 2023</a></button><br>
<button class="btn btn-warning"><a href="http://localhost/sbr/admin/sbrviewdata2022.php">Click here for 2022</button></a>
