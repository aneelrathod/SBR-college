...
<center><font size=2 color=red><b>User Login Here<b>
<body style="background:url(bgimage.jpg);background-size:100%;background-repeat: no-repeat;">
	<center><div id='tab'> <table border="0" cellpadding="0" cellspacing="0" bgcolor="lime" style="border-radius: 10px 10px 10px 10px ">
	...
	<form name="form" method="POST" action="userlogin.php">
        ...
        <button class="btn btn-warning" value="login" name="login">Login    
        </button></td></tr>
 ...
 if(isset($_POST['login']))
    {
        ...
        $check_user="select* from userpass2 where username='$username' AND password='$password'";
        $run=mysqli_query($con,$check_user);
        if(mysqli_num_rows($run))
        {
         
            echo "<script> window.open('userwelcome.php','_self')</script>";
    ...
    <hr>
    <marquee><font color="red">Addmission open for 2023 PUC,BCA,B.Com,Bsc,MBA.MCA</marquee>
    <button class="btn btn-warning"><a href="http://localhost/sbr/home.php">Back to home page</a></button></center>
    <hr><hr><hr>
